...
try:
    ...
    with open('mlp_eval_metrics.json', 'w') as f:
        json.dump(metrics, f)

    # Save confusion matrix
    np.save('mlp_confusion_matrix.npy', cm)

    # Save classification report
    with open('mlp_classification_report.txt', 'w') as f:
        f.write(classification_report(y_val, y_pred_classes, target_names=nomes_classes))

    # Save best hyperparameters
    with open('mlp_best_hyperparams.json', 'w') as f:
